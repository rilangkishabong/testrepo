...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Depute Staff</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Depute Staff</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-sm-3">
                    <button class="btn btn-block btn-warning btnlvls" href="#" data-id="" data-toggle="modal"
                        data-target="#modal-add_deput">Depute Staff</button>
                </div>
            </div>
            <div class="row">
                            ...
                            <div style="height: 100%; width: 100%; overflow-x:scroll">
                                    ...
                                    <tbody>
                                        @foreach ($depute_stafs as $depute_staf)
                                            <tr class="mytr">
                                                ...
                                                <td>{{ $depute_staf->deput_status }}</td>
                                                <td>{{ $depute_staf->dep_reason }}</td>
                                                ...
                                                <td>
                                                    @if (Carbon\Carbon::parse($depute_staf->dep_date_from)->diffInDays(now(), false)!=0)
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <form method="post"
                                                                action="{{ route('depute-staff.destroy', [$depute_staf->id]) }}">
                                                                {{ csrf_field() }}
                                                                @csrf
                                                                @method('DELETE')
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Depute Staff For Tour/View</h4>
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="{{ route('depute-staff.store') }}">
                                                    @csrf
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Date Posted</label>
                                                                    ...
                                                                    value="{{ $curdate }}" required readonly>
                                                        </div>
                                ...
                                <div class="modal fade" id="modal-depulist">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Change Deput Data</h4>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" id="deputupdateform">
                                                    @csrf
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="">Employee Name</label>
                                                            <input type="hidden" name="prid" id="prid">
                                                            <select name="empname_upd" id="empname_upd" class="form-control" required>
                                                                <option value="">Select Employee</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Date Posted</label>
                                                                    <input type="date" class="form-control"
                                                                    name="emp_date_upd" id="emp_date_upd"
                                                                    value="{{ $curdate }}" required readonly>
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default"
...
<script src="{{ asset('js/admin-depute-staff.js') }}"></script>
