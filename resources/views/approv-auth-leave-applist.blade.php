                                ...
                                <table id="tableID" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($leavetype_apps as $leavetype_apps)
                                            <tr class="mytr">
                                                <td>{{ $leavetype_apps->emp_id }}</td>
                                                <td>{{ $leavetype_apps->name }}</td>
                                                <td>{{ $leavetype_apps->desg }}</td>
                                                <td>
                                                    <?php
                                                    $date=date_create($leavetype_apps->date_from);
                                                    echo date_format($date,"d/m/Y");
                                                    ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    $date=date_create($leavetype_apps->date_to);
                                                    echo date_format($date,"d/m/Y");
                                                    ?>
                                                </td>
                                                ...
                                                <td>
                                                    <?php
                                                    $date=date_create($leavetype_apps->date_posted);
                                                    echo date_format($date,"d/m/Y");
                                                    ?>
                                                </td>
                                                <td>
