...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Depute Duties</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Depute Duties</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            {{-- <div class="row">
                <div class="col-sm-3">
                    <button class="btn btn-block btn-warning btnlvls" href="#" data-id="" data-toggle="modal"
                        data-target="#modal-add_deput">Depute Duties</button>
                </div>
            </div> --}}
            <div class="row">
                                            ...
                                            <tr class="mytr">
                                                ...
                                                <td>
                                                    @if ($depute_staf->tourid == 4 )
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <button class="btndeputaccept" href="#" data-id="{{ $depute_staf->id }}">Accept</button>
                                                            </div>
                                                        </div>
                                                    @else
...
<script src="{{ asset('js/depute-request.js') }}"></script>
