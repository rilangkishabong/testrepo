                    ...
                    <div class="card ">
                        ...
                        <div class="card-body">
                            <div style="height: 100%; width: 100%;">
                                <form method="POST" id="employeelistform" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label for="selemployees">All Employees</label>
                                                <select name="selemployees" id="selemployees" required>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="selyear" id="selyear" required>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="selmonth" id="selmonth" required>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="selleavetype" id="selleavetype" required>
                                    ...
                                    <tbody>
                                        @foreach ($leavetype_apps as $leavetype_apps)
                                            <tr class="mytr">
                                                ...
                                                <td>
                                                    <button class="btn btn-block btn-warning btnlvls" href="#" data-id="{{ $leavetype_apps->id }}" data-toggle="modal"
                                                        data-target="#modal-leavelist">Edit</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
